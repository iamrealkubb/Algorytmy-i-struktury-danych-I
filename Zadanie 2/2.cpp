...
template <typename T>
void bubbleSort(T *tablica, int rozmiar) {
    for (int i = 0; i < rozmiar - 1; i++) {
        for (int j = 0; j < rozmiar - i - 1; j++) {             // Iterujemy po wszystkich elementach tablicy
...
int main() {
    ...
    int rozmiar1 = sizeof(tablica1) / sizeof(tablica1[0]); // Obliczenie rozmiaru tablicy
    ...
    bubbleSort(tablica1, rozmiar1); // Wywolanie sortowania babelkowego
